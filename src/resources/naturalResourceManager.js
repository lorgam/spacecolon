...
const naturalResourceManager = {
	resources : {
		...
		GRASSLIFE	: {id:3,color:"#5774AA",text:"fish",default:25,terrain:['grass','grassMountain','forest']},
		SEALIFE		: {id:4,color:"#FFFFFF",text:"hervibore",default:50,terrain:['deepOcean','ocean']}
	}
}
